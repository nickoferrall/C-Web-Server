...
void get_file(int fd, struct cache *cache, char *request_path)
{
    ...
    // IMPLEMENT ME! //
    ///////////////////
    char filepath[4096]; // any reason for this specific number - why so large?
    ...
    if (filedata == NULL)
    {
        // load index.html file if the user just enters '/'
...
void handle_http_request(int fd, struct cache *cache)
{
    ...
    printf("Got the old request.. %s %s\n", request_type, request_path);
